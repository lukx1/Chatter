...
public class UserRepo extends AbstractRepo {
    ...
    public User[] getUsers() throws IOException, URISyntaxException {
        return communicable.Obtain(getController(), "GetUsers", Communicator.HttpMethod.POST, getLoginHeader(), User[].class);
    }
    ...
    public User getUser(int id) throws IOException, URISyntaxException {
        return communicable.Obtain(getController(), "GetUser", Communicator.HttpMethod.POST, createIdObject(id), User.class);
    }
    ...
    public User getUserWithLogin(@NotNull String login) throws IOException, URISyntaxException {
        return communicable.Obtain(getController(), "GetUserWithLogin", Communicator.HttpMethod.POST, new LoginObject(login), User.class);
    }
    ...
    public void registerUser(@NotNull User user) throws IOException, URISyntaxException {
        communicable.Obtain(getController(), "RegisterUser", Communicator.HttpMethod.PUT, user, Void.class);
    }
    ...
    public boolean validateLogin() throws IOException, URISyntaxException {
        return communicable.Obtain(getController(), "ValidateLogin", Communicator.HttpMethod.POST, getLoginHeader(), boolean.class);
    }
    ...
    public boolean deleteUser(int id) throws IOException, URISyntaxException {
        return communicable.Obtain(getController(), "User", Communicator.HttpMethod.DELETE, createIdObject(id), boolean.class);
    }
    ...
    public void setUser(User user) throws IOException, URISyntaxException {
        communicable.Obtain(getController(), "User", Communicator.HttpMethod.POST, getLoginHeader(), Void.class);
    }
